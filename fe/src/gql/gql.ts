 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation studentSignup($email: String!, $firstname: String!, $lastname: String, $dob: Date!, $gender: String, $country: ID!, $parentFirstname: String, $parentLastname: String, $password: String) {\n  studentSignup(\n    input: {studentData: {email: $email, firstname: $firstname, lastname: $lastname, dob: $dob, gender: $gender, country: $country, parentFirstname: $parentFirstname, parentLastname: $parentLastname, password: $password}}\n  ) {\n    student {\n      id\n      firstname\n      lastname\n      zipCode\n      parentFirstname\n      parentLastname\n      email\n      country {\n        id\n        name\n      }\n      parent {\n        id\n        username\n      }\n      email\n    }\n    message\n    status\n  }\n}"): (typeof documents)["mutation studentSignup($email: String!, $firstname: String!, $lastname: String, $dob: Date!, $gender: String, $country: ID!, $parentFirstname: String, $parentLastname: String, $password: String) {\n  studentSignup(\n    input: {studentData: {email: $email, firstname: $firstname, lastname: $lastname, dob: $dob, gender: $gender, country: $country, parentFirstname: $parentFirstname, parentLastname: $parentLastname, password: $password}}\n  ) {\n    student {\n      id\n      firstname\n      lastname\n      zipCode\n      parentFirstname\n      parentLastname\n      email\n      country {\n        id\n        name\n      }\n      parent {\n        id\n        username\n      }\n      email\n    }\n    message\n    status\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
